//
//  UniFileSystemManagerStats.swift
//  TestFra
//
...
public class UniFileSystemManagerStats:NSObject, Stats {
    ...
    private var _mode: NSNumber = 0
    private var _size: NSNumber = 0
    private var _lastAccessedTime: NSNumber = 0
    private var _lastModifiedTime: NSNumber = 0
    private var _mIsFile: Bool = false
    ...
    public var lastAccessedTime: NSNumber {
        ...
        set { _lastAccessedTime = newValue }
    }
    ...
    public var mIsFile: Bool {
        get { return _mIsFile }
        set { _mIsFile = newValue }
    }
    
    public func isDirectory() -> Bool {
        return (UInt16(truncating: _mode) & S_IFMT) == S_IFDIR
    }
    
    public func isFile() -> Bool {
        return (UInt16(truncating: _mode) & S_IFMT) == S_IFREG
    }
...
public class UniFileDecompressTool: NSObject {
        ...
        do {
            ...
            for entry in archive {
                ...
                do {
                    ...
                    // 捕获单个文件解压失败的错误
                    throw UniArchiveError.entryExtractionFailed(entryPath: entry.path, underlyingError: error)
                }
            }
            ...
            case .invalidLocalHeaderDataOffset, .invalidCentralDirectoryOffset, .invalidEntrySize, .invalidCentralDirectorySize, .invalidCentralDirectoryEntryCount:
    ...
    public static func brotliDecompress(filePath: String) throws -> Data {
        ...
        let decompressedData = try data.withUnsafeBytes { (sourcePointer: UnsafeRawBufferPointer) -> Data in
            ...
            let decompressedSize = destinationBuffer.withUnsafeMutableBytes { (destinationPointer: UnsafeMutableRawBufferPointer) -> Int in
