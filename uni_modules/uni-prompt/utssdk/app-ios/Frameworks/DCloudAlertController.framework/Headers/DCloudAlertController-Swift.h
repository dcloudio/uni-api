...
@interface DCActionSheetController (SWIFT_EXTENSION(DCloudAlertController)) <UITableViewDataSource, UITableViewDelegate>
...
@interface DCAlertViewController (SWIFT_EXTENSION(DCloudAlertController)) <UIViewControllerTransitioningDelegate>
